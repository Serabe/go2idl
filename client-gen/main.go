...
import (
	...
	"srcd.works/go2idl.v0/client-gen/generators"
	"srcd.works/go2idl.v0/client-gen/types"
	...
	if *test {
		...
		arguments.CustomArgs = clientgenargs.Args{
			...
			GroupVersionToInputPath: map[types.GroupVersion]string{
				types.GroupVersion{Group: "testgroup", Version: ""}: "srcd.works/go2idl.v0/client-gen/test_apis/testgroup",
			},
			ClientsetName:       "test_internalclientset",
			ClientsetOutputPath: "srcd.works/go2idl.v0/client-gen/testoutput/clientset_generated/",
			ClientsetOnly:       false,
			FakeClient:          true,
			CmdArgs:             cmdArgs,
		}
